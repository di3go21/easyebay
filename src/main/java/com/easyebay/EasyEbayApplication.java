...
public class EasyEbayApplication {

	public static void main(String[] args) {
		SpringApplication.run(EasyEbayApplication.class, args);
	}
	...
	public CommandLineRunner initData(UsuarioServicio usuarioServicio, ProductoServicio productoServicio) {
		return args -> {
			...
			List<Producto> listado = Arrays.asList(new Producto("Bicicleta de montaña", 100.0f,
					"https://cdn.brujulabike.com/media/12165/conversions/blobid1-blobid1-1000-blobid1-blobid1-1000-1000.jpg", usuario),
